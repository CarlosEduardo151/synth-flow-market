...
export const agenteConcorrencia: Product = {
  ...
  badges: ["Assinatura Mensal", "Vantagem Competitiva"],
  features: [
...
- **Reaja rapidamente a mudanças**
- **Identifique oportunidades**
- **Mantenha vantagem competitiva**

## Para quem é

**Empresas que competem em mercados dinâmicos e precisam monitorar concorrência constantemente.**`
};
