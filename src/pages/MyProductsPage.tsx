                ...
                <Card key={product.id} className="overflow-hidden">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      {['crm-simples', 'dashboards-personalizados', 'gestao-cobrancas', 'posts-sociais', 'relatorios-financeiros', 'fidelidade-digital', 'assistente-vendas', 'bots-automacao', 'agente-financeiro', 'agente-rh', 'automacao-notas-fiscais', 'gestao-frotas-oficinas'].includes(product.product_slug) ? (
                        <Button
                          asChild
