...
const timelineData = [
    {
      year: "2025",
      quarter: "Q4",
      title: "Fundação da StarAI",
      description: "Fundação oficial em 13/11/2025 com a missão de democratizar a inteligência artificial para empresas de todos os portes na América Latina.",
      icon: Rocket,
      status: "planned",
      achievements: [
