          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-10 space-y-10">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4 text-muted-foreground leading-7">
                <li><strong>StarAI:</strong> Refere-se à pessoa jurídica responsável pelo desenvolvimento, operação e manutenção de todos os serviços e plataformas descritos neste documento.</li>
