...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-button hover:shadow-glow hover:-translate-y-1",
        ...
        hero: "bg-gradient-primary text-primary-foreground font-semibold shadow-glow hover:shadow-button hover:scale-105 border border-primary/20",
        purchase: "bg-success text-success-foreground font-semibold shadow-button hover:shadow-glow hover:scale-105 text-lg",
        info: "bg-accent/20 text-accent border border-accent/30 hover:bg-accent/30 backdrop-blur-sm",
      },
      size: {
