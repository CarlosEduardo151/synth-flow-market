...
import { CalendarCheck, Video, Clock, CheckCircle, XCircle, Plus, Loader2, Inbox, Mail, Unlink } from 'lucide-react';
            ...
            <div className="flex gap-2 flex-wrap">
              {connection?.connected ? (
                ...
                <Button variant="outline" size="sm" onClick={connectGoogle} disabled={connecting}>
                  ...
                  Conectar NovaLink CRM
                </Button>
              )}
              <Button size="sm" onClick={() => setManualOpen(true)}>
                <Plus className="h-4 w-4 mr-2" />Agendar manual
              </Button>
            </div>
          </div>
        </CardHeader>
